...
import { Package, Wine, History, TrendingUp, Star, Coffee, Zap, LogOut } from "lucide-react"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900">Charutos Manager</span>
            </div>
            ...
            <Card>
              ...
              <CardContent>
                {topRatedCigars.length > 0 ? (
                  ...
                  <p className="text-gray-500 text-center py-4">Realize algumas degustações para ver seus favoritos</p>
                )}
              </CardContent>
            </Card>
          </div>
